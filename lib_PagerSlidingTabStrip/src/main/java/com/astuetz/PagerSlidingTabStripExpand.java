...
public class PagerSlidingTabStripExpand extends HorizontalScrollView {
	...
	private int mCurrentSelectedIndex; //记录viewpager当前选中的索引
	...
	public PagerSlidingTabStripExpand(Context context) {
		this(context, null);
	}

	public PagerSlidingTabStripExpand(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public PagerSlidingTabStripExpand(Context context, AttributeSet attrs, int defStyle) {
		...
		//页签选中字体大小
		tabSelectedTextSize = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsSelectedTextSize, tabSelectedTextSize);
		//页签选中字体颜色
